...
export const relatedTypeEnum = pgEnum("facility_or_provider", [
  "facility",
  "provider",
]);
export const initialOrRenewalEnum = pgEnum("initial_or_renewal", [
  "initial",
  "renewal",
]);
...
export const privilegeTierEnum = pgEnum("privilege_tier", [
  "Inactive",
  "Full",
  "Temp",
  "In Progress",
]);
export const formSizes = pgEnum("form_size", [
  "small",
  "medium",
  "large",
  "x-large",
...
export const facilityStatusEnum = pgEnum("status", [
  "Active",
  "Inactive",
  "In Progress",
]);
...
export const psvStatus = pgEnum("psv_status", [
  "Not Started",
  "Requested",
  "Received",
  "Inactive Rad",
...
export const psvType = pgEnum("psv_type", [
  "Education",
  "Work",
  "Hospital",
  "Peer",
...
export const pendingPSV = pgTable("pending_psv", {
  ...
  agentAssigned: uuid("agent_assigned")
    .notNull()
...
export const incidentLogs = pgTable("incident_logs", {
  ...
  workflowID: uuid("workflow_id")
    .references(() => workflowPhases.id, { onDelete: "cascade" })
    .notNull(),
  whoReported: uuid("who_reported")
    .references(() => agents.id)
    .notNull(),
...
export const providerFacilityCredentials = pgTable(
  "provider_facility_credentials",
  {
    id: uuid("id").defaultRandom().primaryKey(),
...
export const agentsAuthenticatedAll = createAuthenticatedAllPolicy(
  "agents_authenticated_all",
).link(agents);

export const auditLogAuthenticatedAll = createAuthenticatedAllPolicy(
  "audit_log_authenticated_all",
).link(auditLog);

export const facilitiesAuthenticatedAll = createAuthenticatedAllPolicy(
  "facilities_authenticated_all",
).link(facilities);

export const providersAuthenticatedAll = createAuthenticatedAllPolicy(
  "providers_authenticated_all",
).link(providers);

export const workflowPhasesAuthenticatedAll = createAuthenticatedAllPolicy(
  "workflow_phases_authenticated_all",
).link(workflowPhases);

export const facilityContactsAuthenticatedAll = createAuthenticatedAllPolicy(
  "facility_contacts_authenticated_all",
).link(facilityContacts);

export const incidentLogsAuthenticatedAll = createAuthenticatedAllPolicy(
  "incident_logs_authenticated_all",
).link(incidentLogs);

export const pfcWorkflowsAuthenticatedAll = createAuthenticatedAllPolicy(
  "provider_facility_credentials_authenticated_all",
).link(providerFacilityCredentials);

export const prelivePipelineAuthenticatedAll = createAuthenticatedAllPolicy(
  "facility_preline_info_authenticated_all",
).link(facilityPreliveInfo);

export const providerVestaPrivilegesAuthenticatedAll =
  createAuthenticatedAllPolicy(
    "provider_vesta_privileges_authenticated_all",
  ).link(providerVestaPrivileges);

export const stateLicenseWorkflowsAuthenticatedAll =
  createAuthenticatedAllPolicy(
    "provider_state_licenses_authenticated_all",
  ).link(providerStateLicenses);

export const psvAuthenticatedAll = createAuthenticatedAllPolicy(
  "pendingPSV_authenticated_all",
).link(pendingPSV);
